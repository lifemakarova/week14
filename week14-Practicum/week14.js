...
//Создайте массив myFirstArray содержащий строки, числа, булевы значения. Выведите его в консоль.
 const myFirstArray = ['Kristina', 42, true, 'World', 123, false];// объявите переменную здесь

console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
 const mySecondArray =  ['Apple', 'Banana', 'Orange', 'Grapes']; // объявите переменную здесь
...
const myInformation = ['Kristina', 23, 'December', 'Capricorn'];
